...
return {
  -- ファイラ本体
  {
    ...
    local function FernInit()
      ...
      api.nvim_buf_set_keymap(buf, "n", "o", "<Plug>(fern-my-open-or-expand-collapse)", { noremap = false, silent = true })
      ...
      api.nvim_buf_set_keymap(buf, "n", "<C-p>", "<Plug>(fern-action-preview:auto:toggle)", { noremap = false, silent = true })
      api.nvim_buf_set_keymap(buf, "n", "d", "<Plug>(fern-action-preview:scroll:down:half)", { noremap = false, silent = true })
      api.nvim_buf_set_keymap(buf, "n", "u", "<Plug>(fern-action-preview:scroll:up:half)", { noremap = false, silent = true })
